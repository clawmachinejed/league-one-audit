...
export function isLiveNowISO(
  ...
  function windowFor(d: number) {
    ...
    if (d === 4) return startEnd(19, 45, 1, 15, 1); // Thu
    if (d === 7) return startEnd(12, 30, 0, 15, 1); // Sun
    if (d === 1) return startEnd(19, 45, 1, 15, 1); // Mon
    return null;
  }
