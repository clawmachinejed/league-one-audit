...
describe('projection-store public behavior characterization', () => {
  ...
  it('keeps all 64 store-owned SQL operations marked and unique across adapter modules', async () => {
    ...
    expect(extraction.operations).toHaveLength(64);
    ...
    expect(new Set(markers).size).toBe(64);
