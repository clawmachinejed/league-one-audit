...
export const projectionStoreSqlMarkers = [
  ...
  'fail-future-materialization-refresh',
  ...
  'read-all-player-player-metrics',
  ...
  'read-league-lineup-authorities',
  'read-league-season-profile',
  'read-lineup-watch-schedule',
  'read-lineup-watch-states',
  'read-live-defense-stat-capture',
