...
await import(process.argv.includes('--dynasty')
  ? './verify-all-player-dynasty-release-wrapper.ts'
  : process.argv.includes('--hourly')
  ? './verify-all-player-hourly-release-wrapper.ts'
  : process.argv.includes('--participation-assumption')
