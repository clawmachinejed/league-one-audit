...
export type IconName = 'matchups' | 'standings' | 'managers' | 'chevron' | 'arrow' | 'refresh' | 'check' | 'star';
...
export function Icon({ name, className = '' }: { name: IconName; className?: string }) {
  const paths: Record<IconName, ReactNode> = {
    ...
    managers: <><circle cx="9" cy="8" r="3" /><path d="M3 20v-2a6 6 0 0 1 12 0v2m2-15a3 3 0 0 1 0 6m1 3a5 5 0 0 1 3 4v2" /></>,
