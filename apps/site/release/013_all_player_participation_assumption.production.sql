...
BEGIN
  ...
  IF (SELECT count(*) FROM app_schema_migrations) <> 12
    THEN RAISE EXCEPTION 'release assertion failed: expected exactly migrations 001-012'; END IF;
...
INSERT INTO app_schema_migrations(name,checksum)
  VALUES ('013_all_player_participation_assumption.sql','4e03581db2b9a33d0df77110fe32b81745bec7f1ab001a20bfd788c4b4283d80');
DO $repair_after$
DECLARE actual_count integer; actual_not_null_count integer; actual_rows bigint;
  actual_fingerprint text; actual_table_owner text; actual_function_owner text;
  actual_public_execute boolean; actual_runtime_execute boolean; actual_public_grant_execute boolean;
...
BEGIN
  ...
  IF (SELECT checksum FROM app_schema_migrations WHERE name = '013_all_player_participation_assumption.sql')
    IS DISTINCT FROM '4e03581db2b9a33d0df77110fe32b81745bec7f1ab001a20bfd788c4b4283d80' THEN RAISE EXCEPTION 'release assertion failed: 013 checksum'; END IF;
...
END; $repair_after$;
COMMIT;
SELECT 'ALL_PLAYER_PARTICIPATION_ASSUMPTION_APPLIED:013_all_player_participation_assumption.sql:4e03581db2b9a33d0df77110fe32b81745bec7f1ab001a20bfd788c4b4283d80' AS success_sentinel;
