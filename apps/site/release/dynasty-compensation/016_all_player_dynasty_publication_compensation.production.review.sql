-- REVIEW CANDIDATE ONLY: not a current production release authorization.
-- Generated from the exact reviewed 015 production wrapper; no database access.
-- Source 015 checksum: f7bf9b74cc14c0ede7a7534257ea956f99edc2615983b5b66ae546f2812fef8a
-- Source 015 wrapper SHA256: 5a853f19d220dbabe9c15494035b713aa352ef87a1d7c3db481564471459f31c
...
INSERT INTO app_schema_migrations(name,checksum) VALUES ('016_all_player_dynasty_publication_compensation.sql','6afa9ea6f4eaab7dca9b0088ad74cd9a1ccb1dc006f1f6a0414c541976d3ecf8');
DO $compensation_after$
DECLARE old_count record; actual_count integer; actual_not_null_count integer; actual_rows bigint;
  actual_fingerprint text; actual_table_owner text; actual_function_owner text;
  actual_public_execute boolean; actual_runtime_execute boolean; actual_public_grant_execute boolean;
...
BEGIN
  ...
  IF current_setting('server_version_num')::integer NOT BETWEEN 180000 AND 189999
    THEN RAISE EXCEPTION 'release assertion failed: reviewed PostgreSQL 18 required'; END IF;
  IF (SELECT count(*) FROM app_schema_migrations) <> 16
    THEN RAISE EXCEPTION 'release assertion failed: expected unchanged migrations 001-015 plus forward compensation 016'; END IF;
  ...
  IF (SELECT checksum FROM app_schema_migrations WHERE name = '015_all_player_dynasty_publication.sql')
    IS DISTINCT FROM 'f7bf9b74cc14c0ede7a7534257ea956f99edc2615983b5b66ae546f2812fef8a'
    THEN RAISE EXCEPTION 'compensation assertion failed: unchanged installed 015 checksum'; END IF;
  IF (SELECT checksum FROM app_schema_migrations WHERE name = '016_all_player_dynasty_publication_compensation.sql')
    IS DISTINCT FROM '6afa9ea6f4eaab7dca9b0088ad74cd9a1ccb1dc006f1f6a0414c541976d3ecf8'
...
COMMIT;
SELECT 'ALL_PLAYER_DYNASTY_COMPENSATION_APPLIED:016_all_player_dynasty_publication_compensation.sql:6afa9ea6f4eaab7dca9b0088ad74cd9a1ccb1dc006f1f6a0414c541976d3ecf8' AS success_sentinel;
